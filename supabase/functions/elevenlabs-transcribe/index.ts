...
serve(async (req) => {
  ...
  try {
    ...
    console.log(`Transcribing audio: size=${audioFile.size}, language=${languageCode}, diarize=${diarize}`);
    ...
    apiFormData.append('tag_audio_events', String(tagAudioEvents));
    ...
    console.error('Error in elevenlabs-transcribe function:', errorMessage);
    return new Response(
